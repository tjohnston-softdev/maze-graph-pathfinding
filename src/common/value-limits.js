...
const maxGridDimensionNumber = 1000;											// Maximum grid dimension size (500x500)
...
const maxNodeCountNumber = 1000000;												// Maximum node count.
const maxEdgeCountNumber = 1000000;												// Maximum edge count.
